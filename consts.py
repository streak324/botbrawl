...
# the number of frames a fighter is invulnerable after doing a neutral dodge
NEUTRAL_DODGE_INVULN_FRAMES = 16

# the number of frames a fighter is invulnerable after doing an air neutral dodge
AIR_NEUTRAL_DODGE_INVULN_FRAMES = 20

# the number of frames a fighter has after doing an air neutral dodge to initate a gravity cancel
GRAVITY_CANCEL_WINDOW_FRAMES = 16

# the number of frames a fighter is invulnerable after doing a move dodge. side, side air, down air, up air. no matter
MOVE_DODGE_INVULN_FRAMES = 12

# fighter can do another dodge after these number of frames
DODGE_COOLDOWN_FRAMES = 70
